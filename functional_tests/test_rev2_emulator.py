...
class Rev2EmulatorTest(FunctionalTest):
    ...
    def test_main(self):
        ...
        h1 = self.browser.get_element_by_tag_name("h1")
        ...
        json_response = self.get_json_response()
        self.assertEqual(json_response['content']['room_sensor_temperature'], '23.125')
        ...
        self.get_status('FA-32')
        json_response = self.get_json_response()
        self.assertEqual(json_response['content']['room_sensor_temperature'], '15.122')
        ...
        self.submit_button.click()
        json_response = self.get_json_response()
        self.assertEqual(json_response['status'], 300)
        self.assertEqual(json_response['content'], None)
